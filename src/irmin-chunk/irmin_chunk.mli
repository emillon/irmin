...
module AO (S: Irmin.AO.MAKER) (K: Irmin.Hash.S) (V: Irmin.Type.S):
  Irmin.AO.S with type key = K.t
              and type value = V.t
...
module AO_stable (L: Irmin.Link.MAKER)
    (S: Irmin.AO.MAKER) (K: Irmin.Hash.S) (V: Irmin.Type.S):
  Irmin.AO.S with type key = K.t
              and type value = V.t
